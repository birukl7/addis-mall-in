...
function GalleyG1Small({img, person}) {
  return (
    <div className='rounded-xl overflow-hidden bg-cover bg-center h-[350px] px-4 text-white relative' style={{backgroundImage: `url('${img}')`}}>
